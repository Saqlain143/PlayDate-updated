...
const FindOrange = () => {
    ...
    if (capturedImage) {
      try {
        ...
        if (response.ok) {
          ...
          navigate("/findandspeak/great_job");
        } else {
  ...
  return (
    <div className="flex flex-col items-center justify-between min-h-screen p-4 text-white bg-[#1390D2]">
      ...
      <div className="w-full max-w-md mx-auto">
        ...
        {capturedImage && (
          <div className="w-full mb-10">
            <div className="aspect-square mb-15">
              <img
                src={capturedImage}
                alt="Captured"
            ...
            <div className="flex justify-center mt-3">
              <button
                ...
                className="submit_button cursor-pointer px-6 py-3 border-2 border-solid border-black rounded-lg text-white font-bold text-xl bg-[#e97813] hover:bg-[#d16a0f] transition"
              >
                {t("SUBMIT")}
              </button>
            </div>
